...
namespace XexToolGUI
{
    public partial class xexgui : Form
    {
        public xexgui()
        {
            ...
            {
                File.WriteAllBytes(Directory.GetCurrentDirectory() + @"\xextool.exe", Resources.xextool);
            }
        }
        ...
        {
            var num = (int)OpenFileDialog2.ShowDialog();
        ...
        private void PatchxexToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            ProgressBar1.Value = ProgressBar1.Minimum;
            Timer1.Start();
            Process(" -u -p \"" + XeXpFileTextBox.Text + "\" -o \"" + SavePatchTextBox.Text + "\" " +
                    XeXFileTextBox.Text);
        }
        ...
        private void XexExtendedToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Timer1.Start();
            XLogBox.Text =
                "Create Extended Info file with XeXTool GUI\r\n----------------------------------------------------------\r\n";
